...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="kotobi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC6kotobi11AppDelegate")
...
SWIFT_CLASS("_TtC6kotobi8Document")
...
SWIFT_CLASS("_TtC6kotobi19PagesViewController")
@interface PagesViewController : NSViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6kotobi22PagesWindowsController")
@interface PagesWindowsController : NSWindowController
- (void)windowDidLoad;
